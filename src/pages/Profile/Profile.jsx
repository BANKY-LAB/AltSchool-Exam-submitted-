        ...
        <div className="profile-page">
            ...
            <div className="profile-card">
                <div className="image-wrapper">
                   <img className="profile-img" height="200px"  src='./images/profile.jpeg' alt="profile-pic" />
                </div>
            ...
            <div className="social-links">
                <div className="social-links-1">
                    ...
                    <img height="20px" src="./images/github.png" alt="github" />
                    </a>
                </div>
                ...
                <div className="social-links-1">
                    ...
                    <img height="20px" src="./images/linkedin.png" alt="Linked-in" />
                    </a>
                </div>
                <div className="social-links-1">
                    <a target='_blank' href="https://twitter.com/Olowoyeyeoduna2">
                    <img height="20px"  src="./images/x-twitter.svg" alt="X-app" />
                    </a>
                </div>
            </div>
        </div>
